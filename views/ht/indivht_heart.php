<?php
//$this->title = 'HT พบภาวะแทรกซ้อน หัวใจและหลอดเลือด ปี 2558';
$this->params['breadcrumbs'][] = ['label' => 'HT พบภาวะแทรกซ้อน หัวใจและหลอดเลือด', 'url' => ['ht/htheart']];
...
<h4><span class="label label-info">HT พบภาวะแทรกซ้อน หัวใจและหลอดเลือด <?php echo $byear; ?></span></h4>
<?php 
function filter($col) {
