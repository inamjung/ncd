<?php
$this->title = 'HT รับบริการที่สถานบริการ ปี 2558';
$this->params['breadcrumbs'][] = ['label' => 'HT รับบริการที่สถานบริการ', 'url' => ['ht/htpatientvisit']];
...
<div class="pull-left">
    ...
    <a class="btn  btn-info"
       href="<?= Url::to(['htpatientvisit', 'cup' => $cup, 'byear' => $byear]) ?>">
