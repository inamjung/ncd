<?php
//$this->title = 'HT พบภาวะแทรกซ้อน เบาหวาน ปี 2558';
$this->params['breadcrumbs'][] = ['label' => 'HT พบภาวะแทรกซ้อน เบาหวาน', 'url' => ['ht/htdm']];
...
<h4><span class="label label-info">HT พบภาวะแทรกซ้อน เบาหวาน <?php echo $byear; ?></span></h4>
<?php 
function filter($col) {
...
$dataProvider = new ArrayDataProvider([
    ...
    ['class'=>'kartik\grid\SerialColumn'],        
        ...
        [
            'label'=>'พบภาวะแทรกซ้อน เบาหวาน (คน)',
            'attribute'=>'result',
            'headerOptions' => ['class'=>'text-center'],
            'contentOptions' => ['class'=>'text-center'],
        ],
        [
           ...
           //'showPageSummary' => true,
            'panel' => [           
                ...
                'heading' => 'HT พบภาวะแทรกซ้อน เบาหวาน',
