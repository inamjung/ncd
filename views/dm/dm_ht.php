...
<div class="btn-group" role="group" aria-label="...">
            ...
            <a  class="btn btn-primary" href="<?= Url::to(['dm/dmht', 'byear' => '2557']) ?>">2557</a>
            <a  class="btn btn-info" href="<?= Url::to(['dm/dmht', 'byear' => '2558']) ?>">2558</a>
...
$gridColumns = [
    ['class'=>'kartik\grid\SerialColumn'], 
       ...
       [
        ...
        [
            'class' => 'kartik\grid\DataColumn',
            'label'=>'พบภาวะแทรกซ้อนความดัน(คน)',
            'attribute' => 'result',
            'format'=>'integer',
            'pageSummary' => true,
            'vAlign' => 'middle',
...
<?php echo Highcharts::widget([
    'options'=>[        
        'title'=>['text'=>'DM พบภาวะแทรกซ้อนความดัน'],
        'xAxis'=>[
            'categories'=>$cup
        ],
        'yAxis'=>[
