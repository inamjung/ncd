<?php
//$this->title = 'DM พบภาวะแทรกซ้อน หลอดเลือดสมอง ปี 2558';
$this->params['breadcrumbs'][] = ['label' => 'DM พบภาวะแทรกซ้อน หลอดเลือดสมอง', 'url' => ['dm/dmstroke']];
...
<h4><span class="label label-info">DM พบภาวะแทรกซ้อน หลอดเลือดสมอง <?php echo $byear; ?></span></h4>
<?php 
function filter($col) {
...
$dataProvider = new ArrayDataProvider([
    ...
    ['class'=>'kartik\grid\SerialColumn'],        
        ...
        [
            'label'=>'พบภาวะแทรกซ้อน หลอดเลือดสมอง (คน)',
            'attribute'=>'result',
            'headerOptions' => ['class'=>'text-center'],
            'contentOptions' => ['class'=>'text-center'],
        ],
        [
           ...
           //'showPageSummary' => true,
            'panel' => [           
                ...
                'heading' => 'DM พบภาวะแทรกซ้อน หลอดเลือดสมอง',
