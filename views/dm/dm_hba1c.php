...
<div class="btn-group" role="group" aria-label="...">           
     <a  class="btn btn-primary" href="<?= Url::to(['dm/dmhba1c', 'byear' => '2557']) ?>">2557</a>
     <a  class="btn btn-info" href="<?= Url::to(['dm/dmhba1c', 'byear' => '2558']) ?>">2558</a>
...
<?php echo Highcharts::widget([
    'options'=>[        
        'title'=>['text'=>'DM ได้รับการตรวจ HbA1C'],
        'xAxis'=>[
            'categories'=>$cup
        ],
        'yAxis'=>[
